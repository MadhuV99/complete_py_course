...
def create():
    ...
    content = request.args.get(
        'content')  # This takes the 'This is the post content' form the content query string parameter.
    post_id = len(
        posts)  # This just gives us a new post_id as the number of posts currently existing (thing of it as an auto-increment).
